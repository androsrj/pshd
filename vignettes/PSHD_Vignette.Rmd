...
```
It is easy to see that the estimate from $a=0.25$ has far more edges present than the estimate with $a=1.75$. Thus, the adjustment of penalty values grants the user a built-in approach to obtain a desired density or sparsity in the final estimate.
